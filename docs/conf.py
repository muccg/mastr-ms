...
project = u'Mastr-MS'
copyright = u'2013, Centre for Comparative Genomics'
...
latex_documents = [
  ('index', 'Mastr-MS.tex', u'Mastr-MS Documentation',
   u'Centre for Comparative Genomics', 'manual'),
]
...
man_pages = [
    ('index', 'mastr-ms', u'Mastr-MS Documentation',
     [u'Centre for Comparative Genomics'], 1)
]
...
texinfo_documents = [
  ('index', 'Mastr-MS', u'Mastr-MS Documentation',
   u'Centre for Comparative Genomics', 'Mastr-MS', 'One line description of project.',
   'Miscellaneous'),
]
