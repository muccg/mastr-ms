...
urlpatterns = patterns('',
    ...
    (r'^nodes', 'madas.mdatasync_server.views.get_node_clients'),
    (r'^node/(?P<organisation>.*)/(?P<sitename>.*)/(?P<station>.*)/', 'madas.mdatasync_server.views.nodeinfo'),
    (r'^requestsync/(?P<organisation>.*)/(?P<sitename>.*)/(?P<station>.*)/', 'madas.mdatasync_server.views.request_sync'),
    (r'^syncadmin/(.*)', include(admin.site.urls)),
    (r'^logupload/', 'madas.mdatasync_server.views.log_upload'),
    (r'^keyupload/', 'madas.mdatasync_server.views.key_upload'),
