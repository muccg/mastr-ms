...
<link rel="stylesheet" href="${wh.url('/static/ext-3.2.1/resources/css/ext-all.css')}"/>
<link rel="stylesheet" type="text/css" href="${wh.url('/static/css/main.css')}"/>
<link rel="stylesheet" href="${wh.url('/static/ext-3.2.1/examples/ux/css/RowEditor.css')}"/>
<link rel="stylesheet" type="text/css" href="${wh.url('/static/css/file-upload.css')}"/>
<script src="${wh.url('/static/ext-3.2.1/adapter/ext/ext-base.js')}" type="text/javascript"></script>

<script src="${wh.url('/static/ext-3.2.1/ext-all-debug.js')}"></script>
