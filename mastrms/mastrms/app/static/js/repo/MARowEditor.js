 ...
 * @ptype roweditor
 */
Ext.ux.grid.MARowEditor = Ext.extend(Ext.Panel, {
    floating: true,
    shadow: false,
    layout: 'hbox',
    cls: 'x-small-editor',
    ...
    initComponent: function(){
        ...
        this.addEvents(
             ...
             * @param {Ext.ux.grid.MARowEditor} roweditor This object
...
Ext.preg('roweditor', Ext.ux.grid.MARowEditor);
