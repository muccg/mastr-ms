...
urlpatterns = patterns(
    '',
    # Quotes views
    (r'^listFormal/(?P<qid>\d+)/?$',
     'mastrms.quote.views.listFormal',
    ...
    (r'^listNeedsAttention/?$',
     'mastrms.quote.views.listQuotesRequiringAttention',
     {'SSL': settings.SSL_ENABLED}),
    ...
    (r'^downloadAttachment/?$',
     'mastrms.quote.views.downloadAttachment',
     {'SSL': settings.SSL_ENABLED}),
    ...
    (r'^viewformal/?$',
     'mastrms.quote.views.viewFormalRedirect',
     {'SSL': settings.SSL_ENABLED}),
