...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Experiment.sample_preparation_notes'
        db.add_column('repository_experiment', 'sample_preparation_notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Experiment.sample_preparation_notes'
        db.delete_column('repository_experiment', 'sample_preparation_notes')
    ...
    models = {
        ...
        'repository.instrumentmethod': {
            ...
            'created_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
