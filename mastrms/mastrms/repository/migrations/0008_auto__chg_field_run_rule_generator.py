...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Run.rule_generator'
        db.alter_column(u'repository_run', 'rule_generator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repository.RuleGenerator'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Run.rule_generator'
        raise RuntimeError("Cannot reverse this migration. 'Run.rule_generator' and its values cannot be restored.")
