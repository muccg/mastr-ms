...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        """
        to_fix = [("repository.BiologicalSource",
                   ["label", "information"]),
                  ("repository.AnimalInfo",
                   ["location", "notes"]),
                  ("repository.PlantInfo",
                   ["development_stage", "location", "growing_place", "light_source", "lamp_details"]),
                  ("repository.HumanInfo", ["diagnosis", "location", "notes"]),
                  ("repository.MicrobialInfo",
                   ["genus", "species", "culture_collection_id", "media", "fermentation_vessel",
                    "fermentation_mode", "gas_type", "gas_delivery_method"]),
                  ("repository.Organ", ["name", "detail"]),
                  ("repository.ExperimentStatus", ["description"]),
                  ("repository.Project", ["description"]),
                  ("repository.InstrumentMethod", ["blank_position"]),
                  ("repository.Experiment", ["description", "comment", "sample_preparation_notes"]),
                  ("repository.StandardOperationProcedure",
                   ["responsible", "label", "area_where_valid", "comment", "organisation", "version",
                    "defined_by", "replaces_document", "content"]),
                  ("repository.Treatment", ["description"]),
                  ("repository.SampleTimeline", ["timeline"]),
    ...
    models = {
        ...
        u'repository.experiment': {
            ...
            'sample_preparation_notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
