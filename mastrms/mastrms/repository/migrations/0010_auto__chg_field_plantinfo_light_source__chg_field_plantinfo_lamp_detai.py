...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlantInfo.light_source'
        db.alter_column(u'repository_plantinfo', 'light_source', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'PlantInfo.lamp_details'
        db.alter_column(u'repository_plantinfo', 'lamp_details', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'PlantInfo.growing_place'
        db.alter_column(u'repository_plantinfo', 'growing_place', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'PlantInfo.location'
        db.alter_column(u'repository_plantinfo', 'location', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'PlantInfo.development_stage'
        db.alter_column(u'repository_plantinfo', 'development_stage', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'SampleTimeline.timeline'
        db.alter_column(u'repository_sampletimeline', 'timeline', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'BiologicalSource.information'
        db.alter_column(u'repository_biologicalsource', 'information', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'BiologicalSource.label'
        db.alter_column(u'repository_biologicalsource', 'label', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'RunSample.filename'
        db.alter_column(u'repository_run_samples', 'filename', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Project.description'
        db.alter_column(u'repository_project', 'description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'StandardOperationProcedure.comment'
        db.alter_column(u'repository_standardoperationprocedure', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'StandardOperationProcedure.replaces_document'
        db.alter_column(u'repository_standardoperationprocedure', 'replaces_document', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'StandardOperationProcedure.organisation'
        db.alter_column(u'repository_standardoperationprocedure', 'organisation', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'StandardOperationProcedure.responsible'
        db.alter_column(u'repository_standardoperationprocedure', 'responsible', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'StandardOperationProcedure.area_where_valid'
        db.alter_column(u'repository_standardoperationprocedure', 'area_where_valid', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'StandardOperationProcedure.label'
        db.alter_column(u'repository_standardoperationprocedure', 'label', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'StandardOperationProcedure.content'
        db.alter_column(u'repository_standardoperationprocedure', 'content', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'StandardOperationProcedure.version'
        db.alter_column(u'repository_standardoperationprocedure', 'version', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'StandardOperationProcedure.defined_by'
        db.alter_column(u'repository_standardoperationprocedure', 'defined_by', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'RuleGenerator.node'
        db.alter_column(u'repository_rulegenerator', 'node', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Organ.detail'
        db.alter_column(u'repository_organ', 'detail', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Organ.name'
        db.alter_column(u'repository_organ', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ExperimentStatus.description'
        db.alter_column(u'repository_experimentstatus', 'description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'AnimalInfo.notes'
        db.alter_column(u'repository_animalinfo', 'notes', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'AnimalInfo.location'
        db.alter_column(u'repository_animalinfo', 'location', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'InstrumentMethod.blank_position'
        db.alter_column(u'repository_instrumentmethod', 'blank_position', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'HumanInfo.notes'
        db.alter_column(u'repository_humaninfo', 'notes', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'HumanInfo.sex'
        db.alter_column(u'repository_humaninfo', 'sex', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'HumanInfo.location'
        db.alter_column(u'repository_humaninfo', 'location', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'HumanInfo.diagnosis'
        db.alter_column(u'repository_humaninfo', 'diagnosis', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'MicrobialInfo.media'
        db.alter_column(u'repository_microbialinfo', 'media', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'MicrobialInfo.gas_type'
        db.alter_column(u'repository_microbialinfo', 'gas_type', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'MicrobialInfo.gas_delivery_method'
        db.alter_column(u'repository_microbialinfo', 'gas_delivery_method', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'MicrobialInfo.culture_collection_id'
        db.alter_column(u'repository_microbialinfo', 'culture_collection_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'MicrobialInfo.genus'
        db.alter_column(u'repository_microbialinfo', 'genus', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'MicrobialInfo.fermentation_vessel'
        db.alter_column(u'repository_microbialinfo', 'fermentation_vessel', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'MicrobialInfo.species'
        db.alter_column(u'repository_microbialinfo', 'species', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'MicrobialInfo.fermentation_mode'
        db.alter_column(u'repository_microbialinfo', 'fermentation_mode', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'UserExperiment.additional_info'
        db.alter_column(u'repository_userexperiment', 'additional_info', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Experiment.comment'
        db.alter_column(u'repository_experiment', 'comment', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Experiment.description'
        db.alter_column(u'repository_experiment', 'description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Experiment.sample_preparation_notes'
        db.alter_column(u'repository_experiment', 'sample_preparation_notes', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Run.generated_output'
        db.alter_column(u'repository_run', 'generated_output', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Run.title'
        db.alter_column(u'repository_run', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Sample.comment'
        db.alter_column(u'repository_sample', 'comment', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Treatment.description'
        db.alter_column(u'repository_treatment', 'description', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'PlantInfo.light_source'
        db.alter_column(u'repository_plantinfo', 'light_source', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'PlantInfo.lamp_details'
        db.alter_column(u'repository_plantinfo', 'lamp_details', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'PlantInfo.growing_place'
        db.alter_column(u'repository_plantinfo', 'growing_place', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'PlantInfo.location'
        db.alter_column(u'repository_plantinfo', 'location', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'PlantInfo.development_stage'
        db.alter_column(u'repository_plantinfo', 'development_stage', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SampleTimeline.timeline'
        db.alter_column(u'repository_sampletimeline', 'timeline', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'BiologicalSource.information'
        db.alter_column(u'repository_biologicalsource', 'information', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'BiologicalSource.label'
        db.alter_column(u'repository_biologicalsource', 'label', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'RunSample.filename'
        db.alter_column(u'repository_run_samples', 'filename', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Project.description'
        db.alter_column(u'repository_project', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'StandardOperationProcedure.comment'
        db.alter_column(u'repository_standardoperationprocedure', 'comment', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'StandardOperationProcedure.replaces_document'
        db.alter_column(u'repository_standardoperationprocedure', 'replaces_document', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'StandardOperationProcedure.organisation'
        db.alter_column(u'repository_standardoperationprocedure', 'organisation', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'StandardOperationProcedure.responsible'
        db.alter_column(u'repository_standardoperationprocedure', 'responsible', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'StandardOperationProcedure.area_where_valid'
        db.alter_column(u'repository_standardoperationprocedure', 'area_where_valid', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'StandardOperationProcedure.label'
        db.alter_column(u'repository_standardoperationprocedure', 'label', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'StandardOperationProcedure.content'
        db.alter_column(u'repository_standardoperationprocedure', 'content', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'StandardOperationProcedure.version'
        db.alter_column(u'repository_standardoperationprocedure', 'version', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'StandardOperationProcedure.defined_by'
        db.alter_column(u'repository_standardoperationprocedure', 'defined_by', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'RuleGenerator.node'
        db.alter_column(u'repository_rulegenerator', 'node', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Organ.detail'
        db.alter_column(u'repository_organ', 'detail', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Organ.name'
        db.alter_column(u'repository_organ', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ExperimentStatus.description'
        db.alter_column(u'repository_experimentstatus', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'AnimalInfo.notes'
        db.alter_column(u'repository_animalinfo', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'AnimalInfo.location'
        db.alter_column(u'repository_animalinfo', 'location', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'InstrumentMethod.blank_position'
        db.alter_column(u'repository_instrumentmethod', 'blank_position', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'HumanInfo.notes'
        db.alter_column(u'repository_humaninfo', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'HumanInfo.sex'
        db.alter_column(u'repository_humaninfo', 'sex', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'HumanInfo.location'
        db.alter_column(u'repository_humaninfo', 'location', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'HumanInfo.diagnosis'
        db.alter_column(u'repository_humaninfo', 'diagnosis', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'MicrobialInfo.media'
        db.alter_column(u'repository_microbialinfo', 'media', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MicrobialInfo.gas_type'
        db.alter_column(u'repository_microbialinfo', 'gas_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MicrobialInfo.gas_delivery_method'
        db.alter_column(u'repository_microbialinfo', 'gas_delivery_method', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MicrobialInfo.culture_collection_id'
        db.alter_column(u'repository_microbialinfo', 'culture_collection_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MicrobialInfo.genus'
        db.alter_column(u'repository_microbialinfo', 'genus', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MicrobialInfo.fermentation_vessel'
        db.alter_column(u'repository_microbialinfo', 'fermentation_vessel', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MicrobialInfo.species'
        db.alter_column(u'repository_microbialinfo', 'species', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MicrobialInfo.fermentation_mode'
        db.alter_column(u'repository_microbialinfo', 'fermentation_mode', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'UserExperiment.additional_info'
        db.alter_column(u'repository_userexperiment', 'additional_info', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Experiment.comment'
        db.alter_column(u'repository_experiment', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Experiment.description'
        db.alter_column(u'repository_experiment', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Experiment.sample_preparation_notes'
        db.alter_column(u'repository_experiment', 'sample_preparation_notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Run.generated_output'
        db.alter_column(u'repository_run', 'generated_output', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Run.title'
        db.alter_column(u'repository_run', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Sample.comment'
        db.alter_column(u'repository_sample', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Treatment.description'
        db.alter_column(u'repository_treatment', 'description', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'repository.instrumentmethod': {
            ...
            'created_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.User']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
