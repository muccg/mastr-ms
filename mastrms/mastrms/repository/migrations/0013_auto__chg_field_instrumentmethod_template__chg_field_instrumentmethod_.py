...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'InstrumentMethod.template'
        db.alter_column(u'repository_instrumentmethod', 'template', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'InstrumentMethod.method_path'
        db.alter_column(u'repository_instrumentmethod', 'method_path', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'InstrumentMethod.template'
        db.alter_column(u'repository_instrumentmethod', 'template', self.gf('django.db.models.fields.TextField')())

        # Changing field 'InstrumentMethod.method_path'
        db.alter_column(u'repository_instrumentmethod', 'method_path', self.gf('django.db.models.fields.TextField')())
