...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'repository_investigation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repository.Project'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'repository', ['Investigation'])

        # Adding field 'Experiment.investigation'
        db.add_column(u'repository_experiment', 'investigation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repository.Investigation'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Investigation'
        db.delete_table(u'repository_investigation')

        # Deleting field 'Experiment.investigation'
        db.delete_column(u'repository_experiment', 'investigation_id')
    ...
    models = {
        ...
        u'repository.experiment': {
            ...
            'investigation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['repository.Investigation']", 'null': 'True', 'blank': 'True'}),
