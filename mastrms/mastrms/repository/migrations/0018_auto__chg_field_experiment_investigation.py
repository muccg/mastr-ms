...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Experiment.investigation'
        db.alter_column(u'repository_experiment', 'investigation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repository.Investigation'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Experiment.investigation'
        db.alter_column(u'repository_experiment', 'investigation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repository.Investigation'], null=True))
    ...
    models = {
        ...
        u'mdatasync_server.nodeclient': {
            ...
            'default_data_path': ('django.db.models.fields.CharField', [], {'default': "'/usr/local/src/mastrms/mastrms/scratch/files'", 'max_length': '255'}),
            'flags': ('django.db.models.fields.CharField', [], {'default': "'--protocol=30 -rzv --chmod=ug=rwX'", 'max_length': '255'}),
            'hostname': ('django.db.models.fields.CharField', [], {'default': "u'mastrms.localdomain'", 'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'organisation_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'samplefile_ext': ('django.db.models.fields.CharField', [], {'default': "'.d'", 'max_length': '255', 'blank': 'True'}),
        ...
        u'quote.formalquote': {
            ...
            'downloaded': ('django.db.models.fields.BooleanField', [], {}),
        ...
        u'repository.experiment': {
            ...
            'investigation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['repository.Investigation']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
