...
urlpatterns = patterns('mastrms.repository.views',
    ...
    (r'^deleteFile[/]*$', 'deleteFile', {'SSL':settings.SSL_ENABLED}),
    ...
    url(r'^downloadFile[/]*$', 'downloadFile', {'SSL':settings.SSL_ENABLED}, name="downloadFile"),
    url(r'^downloadClientFile/(?P<filepath>.+)$', 'downloadClientFile', {'SSL':settings.SSL_ENABLED}, name="downloadClientFile"),
    ...
    url(r'^downloadRunFile[/]*$', 'downloadRunFile', {'SSL':settings.SSL_ENABLED}, name="downloadRunFile"),
