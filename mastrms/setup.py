...
for package in ('app', 'admin', 'dashboard', 'login', 'mdatasync_server', 'quote', 'registration', 'repository', 'users'):
    ...
    for data_dir in ('templates', 'templatetags', 'static', 'migrations', 'fixtures', 'views', 'utils', 'test'):
...
setup(name='django-mastrms',
    ...
    packages=[
        ...
        'mastrms.api',
        'mastrms.app',
        'mastrms.app.initial_data',
        'mastrms.app.management',
        'mastrms.app.management.commands',
        'mastrms.admin',
        'mastrms.dashboard',
        'mastrms.login',
    ...
    zip_safe=False,
    scripts=["scripts/mastrms-manage.py", "scripts/gen-secret-key"],
)
